...
const UpdatePromotionalBanner = ({ banner }: { banner: Doc<'banner'> }) => {
  ...
  return (
    <div className='flex space-x-6'>
      <div className='max-w-2xl flex-1 p-6'>
        <h2 className='mb-6 text-2xl font-bold'>Update Promotional Banner</h2>
      ...
      <div className='mb-6 p-6'>
        <h3 className='mb-2 text-xl font-bold'>Current Banner Image:</h3>
