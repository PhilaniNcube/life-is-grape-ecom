...
const SpiritProductFilter = ({ slug }: { slug: string }) => {
      ...
      <div className='my-2 md:hidden'>
        ...
        <div className='flex flex-wrap gap-2'>
          {categoriesQuery?.map(category => {
            return (
              <Link key={category._id} href={`/spirits/${category.slug}`}>
                <Badge
                  variant='outline'
                  className={cn(
...
export default SpiritProductFilter
