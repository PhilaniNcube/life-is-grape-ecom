...
const PaymentForm = ({ order }: { order: Doc<'orders'> }) => {
  ...
  const generateUploadUrl = useMutation(
    api.personalised_labels.generatePersonalisedLabelUploadUrl
  )
  ...
  const hasPersonalizedLabels = cart.some(
      ...
      <Card className='mx-auto max-w-6xl'>
        ...
        <CardContent className='flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0'>
          <div className='w-full p-4'>
                ...
                <div className='space-y-2'>
                    ...
                    action={async formData => {
                      try {
                        ...
                        startTransition(async () => {
                          const res = await createPersonalisedLabel(
                            null,
                            formData
                          )
                  ...
                  >
                    ...
                    <Button
                      ...
                      className={cn(
                        'w-full rounded-none bg-blue-800',
                        uploadingLabel && 'animate-pulse opacity-50'
                      )}
                    >
            ...
            {labelUploaded && (
              <div className='mt-8 bg-green-100 p-4 text-green-800'>
                <p>
                  Personalized label uploaded successfully! Continue to confirm
                  payment.
                </p>
              </div>
            )}
          ...
          <div className='flex w-full max-w-xl flex-col justify-between space-y-2 bg-gray-100 p-4'>
            ...
            <form
              ...
              className=''
            >
              <div className='flex h-full flex-1 flex-grow items-end'>
                <CustomButton disabled={isPending} className='w-full' size='lg'>
                  Confirm Order
                </CustomButton>
              </div>
            </form>
