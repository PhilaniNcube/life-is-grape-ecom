    ...
    <Card className='group overflow-hidden transition-all hover:shadow-lg'>
      ...
      <CardContent className='p-4'>
        ...
        <p className='line-clamp-2 text-balance text-left text-sm text-muted-foreground'>
          The perfect gift for the wine lover in your life. Our gift vouchers
          are available in a range of denominations and can be redeemed against
          any of our products.
        </p>
      </CardContent>
      <CardFooter className='flex items-center justify-between p-4 pt-0'>
        <p className='font-semibold'>From R100.00</p>
        <CustomButton className='bg-slate-700 text-white'>
